...
video_path = "/datashare/project/vids_test/4_2_24_A_1.mp4"  # Replace with your video path
...
for model_path in model_paths:
    ...
    output_video_path = os.path.join(output_dir, f"test_{model_name}.mp4")
...
print("All models have processed the video.")
