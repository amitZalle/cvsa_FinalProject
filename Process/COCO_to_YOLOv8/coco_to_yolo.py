...
def main(**kwargs):
    ...
    for annotation_file in annotation_files:
        ...
        categories_dict = {category['id']: category['name'] for category in coco_categories}
        ...
        for image in images:
            ...
            classes = [ann['category_id'] for ann in coco_data['annotations'] if ann['image_id'] == image_id]
